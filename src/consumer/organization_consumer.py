...
from src.services.fhir import send_validate_payload, send_payload

logger = logging.getLogger(__name__)


class OrganizationConsumer:
    def __init__(self, app, schema_registry_url, fhir_server_url, topic_name):
        self.app = app
    ...
    def init_topic(self):
        return self.app.topic(self.topic_name)
